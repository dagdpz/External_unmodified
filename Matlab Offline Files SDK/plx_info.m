...
[tscounts_temp, wfcounts, evcounts, contcounts] = mexPlex(4, filename, fullread);
for chan=1:numel(dspchans)
    tscounts(:,dspchans(chan)+1)=tscounts_temp(:,chan+1); % first column of tscounts is zeros and will be removed later in PLX2TDT    
end
end